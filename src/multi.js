var MultiPlayLayer = cc.Layer.extend({
    // sprite:null,
    ctor:function () {
        //////////////////////////////
        // 1. super init first
    ...
    loginConfirm:function(username){
        ...
        glink.connect("127.0.0.1",3010,{uid:username,mode:1},function(data){
            cc.log(data);
            if(data.code == 200){
...
var MultiPlayScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new MultiPlayLayer();
        this.addChild(layer);
    }
});